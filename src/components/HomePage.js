      ...
      <div className="container">
        ...
        <section className="help-section">
          ...
          <p className="help-contact">
            ...
            <span className="whatsapp-link" onClick={openWhatsAppRK}> +1 472 268 4641</span>
          </p>
        ...
        <section className="id-card-section">
          ...
          <div className="id-card-content">
            <p className="id-card-description">
              ...
              Kindly Whatsapp the agent now +1 472 268 4641 to get full information on how to 
        ...
        <section className="id-card-section">
          ...
          <div className="id-card-content">
            <p className="id-card-description">
              This is the platform whatsapp booming group profile. kindly chat up the agent now +14722684641 to get full information on how to get added to the platform group.
            </p>
          </div>
        </section>
